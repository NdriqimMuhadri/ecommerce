  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        Positioned(top: 100, left: 20, right: 20,bottom: 0,
            child: Container(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          fit: BoxFit.cover,
                                          image: NetworkImage(AppConstants.BASE_URL+AppConstants.UPLOAD_URL+cartController.getItems[index].img!.toString())
                                      )
                                  ),
                                ),
                              ),
